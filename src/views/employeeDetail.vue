<template>
  ...
  <v-toast :toast="toast" :isShow="isShow" @isShowToastt="isShowToast" />
</template>
...
export default {
  ...
  components: { VCombobox, MDonVi, VToast },
  props: [
    "isShowFormAdd",
    "employeeSelected",
    "employeeSelectedID",
  ...
  watch: {
    ...
    employeeSelectedID(value) {
      ...
      if (value) {
        ...
        axios
          .get(`https://cukcuk.manhnv.net/api/v1/Employees/${this.employeeSelectedID}`)
          .then((response) => {
        ...
        try {
          axios
            ...
            .then(() => {
              ...
              me.loadDataTableDetail(); // tải lại trang khi thêm nhân viên thành công
              try {
                me.isShowToast(true);
                me.toast = {
                  icon: "bi bi-check-lg btn-close-white",
                  bgColor: "bg-success ",
        ...
        try {
          axios
            ...
            .then(() => {
              ...
              me.loadDataTableDetail(); // tải lại trang khi sửa nhân viên thành công
              try {
                me.isShowToast(true);
                me.toast = {
                  icon: "bi bi-check-lg btn-close-white",
            ...
            .catch(() => {
              try {
                me.isShowToast(true);
                me.toast = {
                  icon: "bi bi-exclamation-triangle btn-close-white",
                  bgColor: "bg-warning ",
